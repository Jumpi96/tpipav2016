Public Class ABMClientes
    ...
    Private Sub lbl_nroDoc_Click(sender As Object, e As EventArgs) Handles lbl_nroDoc.Click
    ...
    Private Sub btnLimpiar_Click(sender As Object, e As EventArgs) Handles cmd_limpiar.Click

    End Sub

    Private Sub ABMClientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
